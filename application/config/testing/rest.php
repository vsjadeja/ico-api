...
|
*/
$config['rest_realm'] = 'TOPScorer API';
...
|
*/
$config['rest_database_group'] = 'testing';
...
$config['rest_pkey_column'] = 'pkey';
$config['rest_enable_content_verification'] = false;
...
$config['rest_timestamp_name'] = 'x-time-key';
$config['rest_bearer_name'] = 'x-bearer-key';
